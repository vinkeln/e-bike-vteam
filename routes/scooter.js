...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    const existingScooters = await scooterModules.getByBikeSerialNum(
      bike_serial_number
    );
    ...
    await scooterModules.addScooter(
      bike_serial_number,
      current_location_id,
      battery_level,
      last_service_date,
...
router.put("/", async (req, res) => {
  ...
  let { current_location_id, battery_level, status, last_service_date } =
    req.body;
  try {
    // Hämta scooter baserat på bikeId
    ...
    await scooterModules.updateScooter(
      current_location_id,
      battery_level,
      status,
      last_service_date,
